...
def gen_fig11():
	...
	f.write("-" * 91)
	f.write("\n")
	f.write("Execution times are shown as X/Y where X = execution time for code generated by BuilDSL and Y = execution time for code generated by GraphIt. Larger the ratio, the better")
	f.write("\n")
